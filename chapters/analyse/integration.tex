...
\begin{definition}[Intégrale d'une fonction en escalier]
	Soient $f : [a, b] \to \R$ une fonction en escalier et $a_i$ les morceaux de la subdivision.
	\\
	Alors on définit :
