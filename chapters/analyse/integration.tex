...
\begin{theorem}[Théorème de la moyenne]
    Soit $f \in \mathcal{C}^0([a, b])$.
    \[ \exists c \in \ ]a, b[ \ : \frac{\int_{a}^{b} f(x) \ \diffd x}{b - a} = f(c) \]
\end{theorem}

\begin{theorem}[Intégration par parties]
	Soient $u, v \in \mathcal{C}^1([a, b])$.
	\begin{align*}
...
\begin{theorem}[Intégration par changement de variable]
	Soient $I \subseteq \R,\ f \in \mathcal{C}^0(I)$ et $\varphi \in \mathcal{C}^1([a, b])$ tel que $\varphi ([a, b]) \subseteq I$.
	\begin{align*}
