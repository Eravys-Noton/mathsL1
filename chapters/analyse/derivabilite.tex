...
\begin{proposition}
	Soient $f : I \to \R$ et $a \in I$, si $f$ est \emph{dérivable} en $a$ alors elle est \emph{continue} en $a$.
\end{proposition}

\begin{definition}[Maximum, minimum]
    Soient $f : I \to \R$ et $a \in I$.
    \begin{enumerate}
        \item On dit que $a$ est un \emph{maximum} si et seulement si : $\forall x \in I,\ f(a) \geq f(x)$.
        \item On dit que $a$ est un \emph{minimum} si et seulement si : $\forall x \in I,\ f(a) \leq f(x)$.
    \end{enumerate}
    On appelle extremum un point qui est soit un maximum soit un minimum.
    \begin{enumerate}
        \item On dit que $a$ est un \emph{maximum local} si et seulement si : $\exists \varepsilon > 0,\ a \text{ est un maximum de } f_{|]a - \varepsilon, a + \varepsilon[}$.
        \item On dit que $a$ est un \emph{minimum local} si et seulement si : $\exists \varepsilon > 0,\ a \text{ est un minimum de } f_{|]a - \varepsilon, a + \varepsilon[}$.
    \end{enumerate}
\end{definition}
...
\begin{definition}
	...
	\begin{enumerate}
		...
		\item $f \in \mathcal{C}^{\infty}(I, \R) = \mathcal{D}^{\infty}(I, \R)$ signifie que $f \in \mathcal{C}^n(I, \R),\ \forall n \in \N$. On dit que les fonctions $\mathcal{C}^{\infty}$ sont des \emph{fonctions lisses}.
	\end{enumerate}
\end{definition}

\begin{proposition}
	$f, g \in \mathcal{C}^n \implies f + g, f \cdot g, f \circ g \in \mathcal{C}^n$
\end{proposition}
...
\begin{definition}
    Soit $f : I \to \R$.
    \begin{enumerate}
        \item On dit que $f$ est \emph{convexe} si et seulement si : 
        \[ \forall x, y \in I,\ \forall \lambda \in [0, 1],\ f(\lambda x + (1 - \lambda)y) \leq \lambda f(x) + (1 - \lambda) f(y) \]
        \item On dit que $f$ est \emph{concave} si et seulement si : 
...
\begin{proposition}
	Si $f$ est \emph{croissante} sur $I$ alors 
	$
	(u_n)_{n \in \N} = 
	\begin{cases}
		u_0 \in I \\
	...
	Si $f$ est \emph{décroissante} sur $I$, alors les suites extraites $(v_n)_{n \in \N} \coloneqq u_{2n}$ et $(w_n)_{n \in \N} \coloneqq u_{2n + 1}$ sont monotones, l'une est \emph{croissante}, l'autre est \emph{décroissante}.
\end{proposition}

\begin{definition}[Point fixe]
	Soient $f : \mathcal{D}_f \to \R$ et $x \in \mathcal{D}_f,\ f(x) = x$. On dit que $x$ est un \emph{point fixe} de $f$.
\end{definition}
...
\begin{definition}[Coefficient de convergence]
    ...
    \begin{itemize}
        \item Si $K = 1$ la convergence est \emph{lente}.
        \item Si $K = 0$ la convergence est \emph{rapide}.
        \item Si $0 < K < 1$ la convergence est \emph{géométrique}.
    \end{itemize}
\end{definition}

\begin{definition}[Fonction contractante]
	Soit $f : I \to \R$.
    On dit que $f$ est \emph{contractante} si et seulement si :
