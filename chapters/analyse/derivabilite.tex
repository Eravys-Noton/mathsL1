...
\begin{proof}
	\cite{derivation_wikiversite} Notons $b = f(a)$. Puisque $g$ est dérivable en $b$, d'après la seconde définition de la dérivabilité, il existe une fonction $u : J \to \R$ telle que :
