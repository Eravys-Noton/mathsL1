...
\begin{theorem}
	Pour tous $I \subseteq \R,\ f : I \to \R,\ a \in I \cup \{-\infty, +\infty\}$ et $\ell \in \R \cup \{-\infty, +\infty\}$.
...
\begin{theorem}[Composition de limites]
	Pour tous $I, J \subseteq \R$, $f : I \to J,\ g : J \to \R$ et $a \in I$ ou éventuellement $a \in \{ \pm \infty \}$ tels que :
	\begin{enumerate}
...
\begin{theorem}[Théorème des valeurs intermédiaires]
	Pour tous $a, b \in \R$ tels que $a < b$ et $f : [a, b] \to \R$ une fonction continue.
...
\begin{proof}
	...
	\begin{itemize}
		...
		\[ f(c) \geq y \]
		On a $f(c) \leq y$ et $f(c) \geq y$ donc $f(c) = y$.
	\end{itemize}
\end{proof}

\begin{theorem}
	Pour tous $a, b \in \R$ tels que $a < b$ et $f :\ ]a, b[ \ \to \R$. 
	Si $f$ est croissante.
	\begin{enumerate}
