...
\begin{definition}[Limite à gauche et à droite]
    Soit $I \subseteq \R,\ a \in I,\ f : I \to \R $.
    \begin{enumerate}
...
\begin{definition}[Continuité]
	Soit $I$ un intervalle, $a \in I,\ f : I \to \R$.
        \\ 
        On dit que $f$ est \emph{continue} si et seulement si :
        \[\lim_{x \to a} f(x) = f(a).\] 
...
\begin{theorem}
	...
	Si $f$ est croissante.
	\begin{enumerate}
		\item $f$ admet une limite en $b$, qui est finie si et seulement si $f$ est \emph{majorée}.
		\item $f$ admet une limite en $a$, qui est finie si et seulement si $f$ est \emph{minorée}.
	\end{enumerate}
	Si $f$ est décroissante.
	\begin{enumerate}
		\item $f$ admet une limite en $b$, qui est finie si et seulement si $f$ est \emph{minorée}.
		\item $f$ admet une limite en $a$, qui est finie si et seulement si $f$ est \emph{majorée}.
	\end{enumerate}
	$\forall x_0 \in ]a, b[$
