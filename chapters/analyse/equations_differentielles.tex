...
\begin{definition}[\'Equation différentielle d'ordre 1]
	...
	\[ y' + a(x)y = b(x) \]
	pour $y \in \mathcal{C}^{1}(\R, \R),\ a, b \in \mathcal{C}^{0}(\R,\R)$.
\end{definition}

\begin{theorem}
	Soient $y \in \mathcal{C}^1(\R, \R),\ a \in \mathcal{C}^0(\R, \R)$, les solutions de :
	\[ y' + a(x)y = 0 \]
...
\begin{proposition}[Variation de la constante]
...
\begin{definition}[\'Equations différentielle d'ordre 2]
	...
	\[ y'' + py' + q = b(x) \]
	pour $y \in \mathcal{C}^{2},\ b \in \mathcal{C}^{0},\ p, q \in \R$.
\end{definition}
...
La variation de la constante est difficilement applicable sur les équations différentielles de second ordre, nous devons trouver d'autres méthodes.
