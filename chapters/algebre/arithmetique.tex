...
\begin{definition}
	...
	\begin{enumerate}
		...
		\item L'ensemble des diviseurs de $\N^*$ commun à $a$ et $b$ admet un plus petit élément. C'est le \emph{plus petit commun multiple} des entiers $a$ et $b$. On le note $\ppcm(a, b)$.
	\end{enumerate}
\end{definition}
