...
\begin{proposition}
	...
	\begin{enumerate}
		...
		\item $a \equiv b \pmod{n} \iff b \equiv a \pmod{n}$ 
		\item $a \equiv b \pmod{n} \text{ et } b \equiv c \pmod{n} \implies a \equiv c \pmod{n}$
		\item $a \equiv b \pmod{n} \text{ et } c \equiv d \pmod{n} \implies a + c \equiv b + d \pmod{n} \text{ et } ac \equiv bd \pmod{n}$
		\item $a \equiv b \pmod{n} \implies a^k \equiv b^k \pmod{n}$
	\end{enumerate}
\end{proposition}
