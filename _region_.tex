\message{ !name(main.tex)}\documentclass[a4paper, 11pt, twoside]{book}
...
\include{chapters/analyse/nombres_reels}
...
\part{Algèbre}
\include{chapters/algebre/calcul_algebrique}
...
\message{ !name(main.tex) !offset(-220) }
